...
function addMasterData($conn, $baseURL, $data) {
    ...
    $qGetCode = "SELECT kode_kategori FROM kategori_rth WHERE kode_kategori = ?";
    ...
    $qInsertMasterData = "INSERT INTO kategori_rth (kode_kategori, nama_kategori, kategori_desc, created_at, created_by, modified_at, modified_by) VALUES (?, ?, ?, ?, ?, ?, ?)";
...
function getMasterDataList($conn, $baseURL) {
    ...
    $qGetMasterData = "SELECT kode_kategori, nama_kategori, kategori_desc FROM kategori_rth ORDER BY created_at DESC";
...
function getMasterData($conn, $baseURL, $data) {
    ...
    $qGetMasterData = "SELECT kode_kategori, nama_kategori, kategori_desc FROM kategori_rth WHERE kode_kategori = ?";
...
function editMasterData($conn, $baseURL, $data) {
    ...
    $qUpdateMasterData = "UPDATE kategori_rth SET nama_kategori = ?, kategori_desc = ?, modified_at = ? WHERE kode_kategori = ?";
...
function deleteMasterData($conn, $baseURL, $data) {
    ...
    $qDeleteMasterData = "DELETE FROM kategori_rth WHERE kode_kategori = ?";
